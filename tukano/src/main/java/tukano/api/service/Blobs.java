...
public interface Blobs {
	 ...
	 *
	 * @param String
	 *            blobId the identifier generated by the Shorts service for this
	 *            blob
	 * @param bytes
	 *            the contents in bytes of the blob resource
	 * @return OK(void) if the upload is new or if the blobId and bytes match an
	 *         existing blob; CONFLICT if a blobId exists but bytes do not match;
	 ...
	 * @param blobId
	 *            the id of the blob;
	 * @return (OK, bytes), if the blob exists; NOT_FOUND, if no blob matches the
	 *         provided blobId
	 */
	 ...
	 * @param blobId
	 *            the id of the blob;
	 * @return (OK, void), if the blob exists and was deleted; NOT_FOUND, if no blob
	 *         matches the provided blobId
	 */
	 ...
	 *
	 * @param userid
	 *            the id of the owner of the blobs;
	 */
